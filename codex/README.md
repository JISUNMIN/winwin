...
- [50. Step 45 Android 로그인 input 검정 화면 수정](./50-step-45-android-auth-input-black-screen-fix.md)
...
- [Backend 13. 상담 텍스트 메시지 쓰기 API 연결](./backend-13-consultation-text-message-write-api.md)
- [Backend 14. 고객 희망 일정 저장 API 연결](./backend-14-customer-desired-schedule-write-api.md)
- [Backend 15. 예약 요청과 결제 완료 API 연결](./backend-15-booking-request-and-payment-complete-api.md)
- [Backend 16. 파트너 상담 종료와 unread 초기화](./backend-16-partner-close-and-unread-reset.md)
- [Backend 17. 고객 상담 목록 API와 화면 연결](./backend-17-customer-consultation-list-api-and-screen.md)
- [Backend 18. 상담 종료 상태 톤 분리](./backend-18-closed-status-tone-separation.md)
- [Backend 19. 상담 요약 카운트와 고객 fallback 정리](./backend-19-consultation-summary-counts-and-customer-fallback.md)
- [Backend 20. API 에러 status 수정과 채팅 미완성 기능 가드](./backend-20-api-error-status-fix-and-chat-honesty-guard.md)
- [Backend 21. 상담 이미지 업로드와 운영 빌드 개발 기능 가리기](./backend-21-consultation-image-upload-and-release-gating.md)
