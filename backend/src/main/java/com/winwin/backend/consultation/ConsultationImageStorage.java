...
@Service
public class ConsultationImageStorage {

  private final Path uploadRoot;

  public ConsultationImageStorage(@Value("${app.upload-dir:uploads}") String uploadDir) {
  ...
  public String store(MultipartFile file) {
    ...
    return "/" + relativeDirectory.resolve(fileName).toString().replace('\\', '/');
  }
